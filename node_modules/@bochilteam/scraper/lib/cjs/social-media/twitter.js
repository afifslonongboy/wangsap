...
async function twitterdl(url) {
    types_js_1.TwitterDownloaderArgsSchema.parse(arguments);
    ...
    return results.map(res => types_js_1.TwitterDownloaderSchema.parse(res));
}
...
async function twitterdlv2(url) {
    ...
    if (results.length === 0)
        throw new utils_js_1.ScraperError(`No results found!\n\n${res}`);
    return results.map(res => types_js_1.TwitterDownloaderV2Schema.parse(res));
}
